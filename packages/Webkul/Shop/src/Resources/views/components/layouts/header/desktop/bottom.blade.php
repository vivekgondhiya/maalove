...
<div class="flex w-full justify-between border border-b border-l-0 border-r-0 border-t-0 px-[60px] max-1180:px-8 " style="background-color: rgb(244 53 130 / var(--tw-bg-opacity)); min-height: 45px; color: #fff;">
